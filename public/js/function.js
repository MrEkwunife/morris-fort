(function ($) {
  ...
  /* Project Layout 3 JS */
  const project_layout3_carousel = new Swiper(
    ".project-layout3-slider .swiper",
    {
      slidesPerView: 1,
      speed: 4500,
      spaceBetween: 20,
  ...
  const testimonial_carousel3 = new Swiper(
    ".testimoinal-layout3-slider .swiper",
    {
      slidesPerView: 1,
      speed: 1000,
      spaceBetween: 30,
  ...
  const service_layout2_carousel = new Swiper(
    ".services-layout2-slider .swiper",
    {
      slidesPerView: 1,
      speed: 1000,
      spaceBetween: 30,
  ...
  const service_layout3_carousel = new Swiper(
    ".services-layout3-slider .swiper",
    {
      slidesPerView: 1,
      speed: 1000,
      spaceBetween: 30,
